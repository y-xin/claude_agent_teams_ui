...
export const ToolApprovalSettingsToggle: React.FC<{ expanded: boolean; onToggle: () => void }> = ({
  ...
  return (
    ...
    >
      ...
      <span>{t('team.toolApproval.settings')}</span>
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {t('team.toolApproval.autoAllowAll')}
      </label>
      ...
      >
        ...
        />
        {t('team.toolApproval.autoAllowFileEdits')}
      </label>
      ...
      >
        ...
        />
        {t('team.toolApproval.autoAllowSafeBash')}
      </label>
      ...
      <div
        ...
        style={{ color: 'var(--color-text-secondary)' }}
      >
        <span className="shrink-0">{t('team.toolApproval.onTimeout')}</span>
        <Select
        ...
        >
          ...
          <SelectContent className="z-[60]">
            <SelectItem value="wait">{t('team.toolApproval.waitForever')}</SelectItem>
            <SelectItem value="allow">{t('team.toolApproval.allow')}</SelectItem>
            <SelectItem value="deny">{t('team.toolApproval.deny')}</SelectItem>
          </SelectContent>
        </Select>

        {settings.timeoutAction !== 'wait' && (
          <>
            <span className="shrink-0">{t('team.toolApproval.after')}</span>
            <input
              type="number"
              min={5}
              max={300}
            ...
            />
            <span className="shrink-0">{t('team.toolApproval.sec')}</span>
          </>
        )}
      </div>
    </div>
